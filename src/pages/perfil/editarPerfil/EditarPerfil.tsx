...
function EditarPerfil() {
  return (
      <>
      <form>
          <div className="space-y-20 bg-crm-branco">
              <div className="border-b border-white/10 pb-12 bg-amber-600 mx-50 py-40">
              <h1 className="font-bold text-crm-preto text-3xl"> Informações pessoais </h1>
              <p className='mt-1 text-sm/6 text-crm-preto'> Mantenha suas informações pessoais atualizadas. </p>
