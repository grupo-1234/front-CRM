    ...
    <nav className="bg-[#FBFAFF] text-[#2B2823] w-full fixed top-0 left-0 z-50 border-b border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center gap-10 text-sm font-medium">
            ...
            <Link to="/produtos" className="hover:text-[#1675F2] transition">
              Produto
            </Link>

            <Link to="/negociacoes" className="hover:text-[#1675F2] transition">
              CRM
            </Link>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-6 font-medium">
          ...
          <Link to="/negociacoes" onClick={closeMenu}>
            CRM
          </Link>

          <a href="#segmentos" onClick={closeMenu}>
            Segmentos
          </a>
